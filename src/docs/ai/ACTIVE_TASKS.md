...
**Hot notes:** TASK-614 done (LoadoutBudgetBar → shared). Quality audit TASK-607–613 done ([archive report](archive/QUALITY_GLOBAL_AUDIT_2026-07-20.md)). TASK-326 partial (HIBP → DEV-001). TASK-500 deferred.
