...
**Hot notes:** TASK-615 done (TASK-610 facade remainder). TASK-614 done (LoadoutBudgetBar → shared). Quality audit TASK-607–613 done. TASK-326 partial (HIBP → DEV-001). TASK-500 deferred.
