...
**Ability/defense word tooltips (2026-07-19):** **TASK-545 done** — `WordHelpTip` + `getAbilityHelp` / `getDefenseHelp` on sheet, guided Abilities, skills defenses; pending-qa **DEV-V-009-T025** / **DEV-V-013-T065**. (Renumbered from conflicting TASK-544.)
