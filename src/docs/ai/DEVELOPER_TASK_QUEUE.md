...
| **DEV-002** | [TASK-383](archive/TASK_QUEUE_DONE.md) — UI Verify CI bootstrap  | **Partial 2026-08-13:** Actions secrets `NEXT_PUBLIC_SUPABASE_URL` + `NEXT_PUBLIC_SUPABASE_PUBLISHABLE_DEFAULT_KEY` set from local env. Remaining: (1) Linux visual baselines if CI still drifts (TASK-744 styleguide ~4px). (2) Optional: add `UI Verify / static-gates` and `UI Verify / visual-a11y` as required checks — **done via branch protection** (job display names `Lint, contrast & static gates` / `Visual regression & accessibility`). | Repo settings + OS-specific baselines | | | | |
...
| ------------- | ----------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------- | ----------------------------------------------------------------------------------------------------------------- |
| **DEV-V-001** | Advanced character creator step guards                | TASK-356, TASK-717                                                                                                                                                       | T001–T016 (16)    | Ready — [open suite](BUILD_VALIDATION.md#dev-v-001--advanced-character-creator-step-guards)                       |
...
| **DEV-V-018** | CreatorPageShell parity                               | TASK-380, TASK-431, TASK-381, TASK-616, TASK-732                                                                                                                                              | T001–T011 (11)    | Ready — [open suite](BUILD_VALIDATION.md#dev-v-018--creatorpageshell-parity-task-380--task-381--task-616)                             |
...
| **DEV-V-050** | Guided creator L3 inline catalog lists                   | TASK-684 / TASK-685 / **TASK-727** / **TASK-724** / **TASK-728** / **TASK-716**                                                                                                 | T001–T005         | Ready — [open suite](BUILD_VALIDATION.md#dev-v-050--guided-creator-l3-inline-catalog-lists-task-684)              |
| **DEV-V-046** | Library power/technique categories + filters          | TASK-673 / TASK-676 / TASK-679 / TASK-680 / TASK-731 / **TASK-725**                                                                                                        | T001–T007         | Ready — [open suite](BUILD_VALIDATION.md#dev-v-046--library-powertechnique-categories--filters-task-673--task-676) |
| **DEV-V-051** | Guided funnel entry, trusted create, feat choice        | **TASK-738**                                                                                                                                                             | T001–T008 (8)     | Ready — [open suite](BUILD_VALIDATION.md#dev-v-051--guided-funnel-entry-trusted-create-feat-choice-task-738)       |
