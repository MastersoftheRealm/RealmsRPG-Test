...
| ---- | ------------- | -------------- |
| **TASK-802** | DEV-V-009 **T055** | Sheet Skills: names are Codex labels (not ids) after Edit Species; hover/focus on a skill name shows the Codex description. Desktop `lg+` + ~360px. |
