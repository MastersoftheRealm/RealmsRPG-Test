...
| **TASK-793** | DEV-V-053 **T006** | `/crafting` and `/my-account` have titles; My Account is noindex; `/rules` has crawlable intro above the iframe. |
