...
| **DEV-V-016** | Library add/load selection parity + GridListRow facts | TASK-379, TASK-437, TASK-475, TASK-536, TASK-541, TASK-564, TASK-574, TASK-480, TASK-675, TASK-691, TASK-712                                                                                         | T001–T019 (+ CI builders/inventory) | Ready — [open suite](BUILD_VALIDATION.md#dev-v-016--library-addload-selection-parity-task-379)                    |
...
| **DEV-V-018** | CreatorPageShell parity                               | TASK-380, TASK-431, TASK-381, TASK-616                                                                                                                                              | T001–T010 (10)    | Ready — [open suite](BUILD_VALIDATION.md#dev-v-018--creatorpageshell-parity-task-380--task-381--task-616)                             |
...
| **DEV-V-048** | Library search toolbar + Enhanced Items tab              | Session                                                                                                                                                                  | T001 (1)          | Ready — [open suite](BUILD_VALIDATION.md#dev-v-048--library-search-toolbar--enhanced-items-tab-session)            |
...
| **DEV-V-050** | Guided creator L3 inline catalog lists                   | TASK-684 / TASK-685                                                                                                                                                      | T001 (1)          | Ready — [open suite](BUILD_VALIDATION.md#dev-v-050--guided-creator-l3-inline-catalog-lists-task-684)              |
| **DEV-V-046** | Library power/technique categories + filters          | TASK-673 / TASK-676                                                                                                                                                      | T001–T003 (3)     | Ready — [open suite](BUILD_VALIDATION.md#dev-v-046--library-powertechnique-categories--filters-task-673--task-676) |
...
| **TASK-642** | DEV-008 | Sign up; `user_profiles.email` matches session email (client cannot spoof). |
...
| **TASK-691** | DEV-V-016 **T018** | Guided Powers/Techniques L2/L3: Official Library columns (powers TP is totalCost, not a dense column); Path badges + max-EN / innate gates unchanged |
...
| **TASK-681** | DEV-V-045 **T002** | Library ↔ Codex: character filter persists across powers/techniques/armaments/feats tabs; clear on one tab clears all; survives refresh |
...
| **Session** | DEV-V-048 **T001** (+ DEV-V-016 **T016**) | My Library search spans to Sync button; **Enhanced Items** tab before Creatures; Enhanced Items full-width search |
...
| **TASK-677** | DEV-V-047 **T001–T002** | Power creator + Codex Feats: all CollapsibleSection / FilterSection panels start collapsed; summaries visible; Show Filters / expand works |
