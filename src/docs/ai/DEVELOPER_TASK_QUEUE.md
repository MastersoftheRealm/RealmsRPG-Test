...
| **DEV-V-024** | ExpandableImage adoption                              | TASK-478                                                                                                                                                                 | T001–T003 (3)     | Ready — [open suite](BUILD_VALIDATION.md#dev-v-024--expandableimage-adoption-task-478)                            |
...
| **TASK-478** | DEV-V-009 **T012** + DEV-V-024 **T001–T003** | Sheet portrait expand vs edit-upload; creature/campaign/account ExpandableImage |
