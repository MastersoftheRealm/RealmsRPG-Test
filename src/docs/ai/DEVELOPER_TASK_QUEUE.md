...
| **DEV-V-009** | Character sheet refactor                              | TASK-317, TASK-348, TASK-365, TASK-375, TASK-318, TASK-349, TASK-483, TASK-485, TASK-486, TASK-502, TASK-478, TASK-508–513, TASK-523, TASK-525, TASK-526, TASK-537, TASK-538, TASK-542, TASK-543, TASK-546, TASK-547, TASK-567, TASK-582, TASK-581, TASK-583, TASK-584, TASK-585, TASK-586, TASK-587, TASK-594, TASK-600, TASK-602, TASK-667, TASK-733, TASK-736, TASK-741, TASK-747, TASK-750, TASK-761, **TASK-773**, **TASK-778**, **TASK-779**, **TASK-780**, **TASK-782**, **TASK-783**, **TASK-786**, **TASK-787**, **TASK-788**, **TASK-800**, **TASK-803**, **TASK-805**, **TASK-815**, **TASK-799**, **TASK-838**, **TASK-837**, **TASK-839**, **TASK-843**, **TASK-835**, **TASK-836**, **TASK-868** | T001–T064         | Ready — [open suite](BUILD_VALIDATION.md#dev-v-009--character-sheet-refactor-task-317-task-348-task-365-task-375-task-483-task-485-task-486-task-502-task-478) |
...
| **TASK-868** | DEV-V-009 **T064** + **T021**; DEV-V-016 **T029** | Loaded sheet at 360/390: scroll a panel → sheet header fully leaves (not a leftover half-strip); scroll to top restores it. Swipe Skills/Archetype/Library: each panel lines up with the header card gutters. Feats: expand a row with Uses/Recovery → facts in the body only; empty Uses/Recovery omitted. `md+` header/grid unchanged. |
...
| **DEV-Q05** | Armament table split | **Open — wait for TASK-871 write-up.** Owner asked whether weapons/armor/shields should leave `official_items`/`user_items` for separate tables. Agent research first; no live migration until you pick keep-discriminator vs split + ADR. |
| **DEV-Q06** | Feat category Offense → Offensive | **Open — wait for TASK-876 SQL preview.** Live `codex_feats.category` UPDATE needs owner approve (codex-data policy). Seed CSV already mixed (`Offense` vs `Offensive`). |
| **DEV-Q07** | Admin changelog retention | **Open — wait for TASK-874 proposal.** Today every Codex edit stores full `before_data`/`after_data`. Decide store-diff-only vs keep snapshots, display shape, and how long to keep rows before any schema/TTL apply. |
