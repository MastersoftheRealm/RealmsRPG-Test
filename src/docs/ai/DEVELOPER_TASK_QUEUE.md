...
| **DEV-V-009** | Character sheet refactor                              | TASK-317, TASK-348, TASK-365, TASK-375, TASK-318, TASK-349, TASK-483, TASK-485, TASK-486, TASK-502, TASK-478, TASK-508–513, TASK-523, TASK-525, TASK-526, TASK-537, TASK-538, TASK-542, TASK-543, TASK-546, TASK-547, TASK-567, TASK-582, TASK-581, TASK-583, TASK-584, TASK-585, TASK-586, TASK-587, TASK-594, TASK-600, TASK-602, TASK-667, TASK-733, TASK-736, TASK-741, TASK-747, TASK-750, TASK-761, **TASK-773**, **TASK-778**, **TASK-779**, **TASK-780**, **TASK-782**, **TASK-783**, **TASK-786**, **TASK-787**, **TASK-788**, **TASK-800**, **TASK-803**, **TASK-805**, **TASK-815**, **TASK-799**, **TASK-838**, **TASK-837**, **TASK-839**, **TASK-843**, **TASK-835**, **TASK-836** | T001–T063         | Ready — [open suite](BUILD_VALIDATION.md#dev-v-009--character-sheet-refactor-task-317-task-348-task-365-task-375-task-483-task-485-task-486-task-502-task-478) |
...
| **DEV-V-020** | Sitewide copy compliance                              | TASK-439, TASK-440, **TASK-784**                                                                                                                                                       | T001–T004 (4)     | Ready — [open suite](BUILD_VALIDATION.md#dev-v-020--sitewide-copy-compliance-task-439)                            |
...
| **TASK-813** | DEV-V-016 **T025** | Library creature expand + Creature Creator Equipment: Qty is `-` unless stored (shared `layout="creature"` section, not a fake 1 / second Qty column). Sheet Inventory steppers still default missing qty to 1. Desktop + ~360px. Skip Legacy `/characters/new/advanced`. |
...
| **DEV-Q04** | TASK-780 feat rank UX | **Open:** pick A–E (or hybrid) then move TASK-780 to ACTIVE. **A (recommended):** drop collapsed Lvl stepper; promote via existing expanded Feat Levels chips. **B:** display-only Rank N collapsed; labeled stepper in expanded Customize. **C:** collapsed Rank ▾ ChipSelect. **D:** Upgrade / Rank down verbs. **E:** collapsed Rank column as ChipSelect, never ± next to Uses. Creature creator same stepper is optional same-pick or later. |
| **DEV-Q04** | TASK-780 feat rank UX | **Open:** pick A–E (or hybrid) then move TASK-780 to ACTIVE. **A (recommended):** drop collapsed Lvl stepper; promote via existing expanded Feat Levels chips. **B:** display-only Rank N collapsed; labeled stepper in expanded Customize. **C:** collapsed Rank ▾ ChipSelect. **D:** Upgrade / Rank down verbs. **E:** collapsed Rank column as ChipSelect, never ± next to Uses. Creature creator same stepper is optional same-pick or later. |
