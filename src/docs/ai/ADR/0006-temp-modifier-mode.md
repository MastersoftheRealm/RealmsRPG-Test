...
5. **Layering:** Temp deltas stack on computed/armor defaults (DR, crit range, etc.) — they do not rewrite armor or ability base allocation. Speed/Evasion **base** edit stays pencil; combat-style override deltas move to Temp Modifier (TASK-586 migration).
