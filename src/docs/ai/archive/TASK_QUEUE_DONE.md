...
- id: TASK-479
  ...
  evidence: |
    ...
    BUILD_VALIDATION DEV-V-024 added. npm run build + targeted vitest pending in same commit.
  developer_test_plan: |
...
- id: TASK-481
  ...
  related_files:
    ...
    - src/docs/ai/ARCHITECTURE_CONSTITUTION.md
  description: |
    Constitution anti-debt ritual. Superseded by owner command /debt — repeatable on demand;
...
- id: TASK-503
  ...
  evidence: |
    ...
    vitest src/lib/guided-creator/build-character.test.ts â€” 4 passed.
...
- id: TASK-486
  ...
  title: Weapons property density Ã¢â‚¬â€ one bullet per line under name
  ...
  developer_test_plan: |
    ...
    Suite DEV-V-009 T009 Ã¢â‚¬â€ see BUILD_VALIDATION.md

  description: |

    Screenshot-audit and fix cramped inline named properties in shared QuickWeaponsTable:

    render one `Ã¢â‚¬Â¢ Property` per line under the weapon name (layout A). Apply globally via
  ...
  acceptance_criteria:
    ...
    - Weapon properties render one `Ã¢â‚¬Â¢ Property` per line under the name in QuickWeaponsTable.
  ...
  evidence: |
    ...
    Before: displayNamedProperties joined as inline `Ã¢â‚¬Â¢ a Ã¢â‚¬Â¢ b Ã¢â‚¬Â¢ c` under name Ã¢â‚¬â€ wraps/crams at ~360px when multiple named props.

    After: NamedPropertiesUnderName stacks one `Ã¢â‚¬Â¢ Name` div per property under the name cell

    (text-text-muted / dark:text-text-secondary; index keys; not a semantic list Ã¢â‚¬â€ visual bullets only).
    ...
    Character consumer: archetype-section WeaponsSection Ã¢â€ â€™ QuickWeaponsTable (Unarmed via trailingRows in same tbody Ã¢â‚¬â€ columns share widths; property stack does not touch Unarmed cells).

    Creature audit: creature-stat-block uses WeaponsListSection (GridListRow + property chips), not QuickWeaponsTable Ã¢â‚¬â€ no parallel cramped-join path; shared-table AC covers consumers of QuickWeaponsTable (character today).
...
- id: TASK-485
  ...
  developer_test_plan: |
    ...
    Suite DEV-V-009 T008 Ã¢â‚¬â€ see BUILD_VALIDATION.md

  description: |

    On character sheet normal (non-edit) view: sub-skills keep Ã¢â€â€ + italic but match base skill
  ...
  evidence: |
    ...
    decorative Ã¢â€â€ aria-hidden; tasks:validate.

  notes: |

    Completed 2026-07-16. No SkillRow fork Ã¢â‚¬â€ play chrome gated on existing isEditing.
...
- id: TASK-484
  ...
  developer_test_plan: |
    ...
    Suite DEV-V-008 T001 + T008 -- see BUILD_VALIDATION.md (no creation chip on header or Edit Archetype; path guidance kept)
...
- id: TASK-007
  ...
  title: Library â€” Show weapon damage and enable in-place Edit/Duplicate
...
- id: TASK-008
  ...
  title: RTDB Enrichment â€” Resolve part IDs and compute costs in creators
...
- id: TASK-009
  ...
  title: Character Sheet â€” Innate toggle hit area & alignment (duplicate check)
...
- id: TASK-010
  ...
  title: Powers/Techniques/Armaments â€” Fix missing/incorrect EN/TP display (duplicate)
  ...
  description: |
    ...
    - To refresh the curated top section, paste raw log entries and request: "Consolidate and update curated feedback" â€” the agent will re-run summarization and update curated sections.
...
- id: TASK-012
  ...
  title: My Account â€” Security audit and feature review
  ...
  notes: |
    ...
    RESOLVED: All gaps addressed â€” TASK-047 (auth provider detection), TASK-046 (username change), TASK-041 (profile picture upload).
...
- id: TASK-022
  ...
  notes: |
    ...
    COMPLIANCE GAP: Acceptance criteria required "Confirmation dialog before deletion" â€” not implemented. See TASK-053.
...
- id: TASK-042
  ...
  notes: "DONE 2026-02-05: Changed 'Level X SpeciesName' to 'Level X â€” SpeciesName' with species in font-medium span for visual distinction. Uses middle dot separator."
...
- id: TASK-054
  ...
  title: Documentation â€” add agent verification guidelines
...
- id: TASK-055
  ...
  description: |
    ...
    Also fix "Next: 2 Points" label â€” abilities 4+ cost 2 points, not the generic "3" shown.
...
- id: TASK-056
  ...
  notes: |
    ...
    DONE 2026-02-06: Verified â€” already handled. sheet-header.tsx uses CSS `capitalize` class on pow_abil/mart_abil spans. archetype-section.tsx uses JS charAt(0).toUpperCase() + slice(1). finalize-step.tsx uses CSS `capitalize`. All single-word ability names are properly capitalized.
...
- id: TASK-059
  ...
  notes: |
    ...
    DONE 2026-02-06: Verified â€” already fully implemented.
...
- id: TASK-061
  ...
  title: TASK-012 completion â€” close security audit with sub-task references
...
- id: TASK-064
  ...
  title: Game rules audit â€” fix terminology and CreatureStatBlock ability schema
  ...
  description: |
    ...
    1. CreatureStatBlock uses D&D ability names (intellect, perception, willpower) â€” Realms uses acuity, intelligence, charisma. Acuity and Intelligence do not display for creator creatures.
...
- id: TASK-072
  ...
  title: Health/Energy edit mode â€” bump current when at max and increasing max
...
- id: TASK-073
  ...
  title: Speed/Evasion base editing â€” pencil icon, hide by default, red/green validation
...
- id: TASK-074
  ...
  title: Dark mode â€” soften contrasting colors for easier viewing
...
- id: TASK-077
  ...
  title: Fix username regex â€” invalid character class in pattern attribute
...
- id: TASK-078
  ...
  title: "Dice roller â€” replace Lucide icons with custom dice PNGs"
...
- id: TASK-079
  ...
  title: "Weapon columns â€” add attack bonus column"
...
- id: TASK-080
  ...
  title: "Unified Selection Modal â€” remove 'Add' column header text"
...
- id: TASK-081
  ...
  title: "Add Skill / Add Sub-Skill modals â€” adopt ListHeader + sort"
...
- id: TASK-082
  ...
  title: "LoadFromLibraryModal â€” remove item count from footer"
...
- id: TASK-083
  ...
  description: |
    ...
    Feedback: "Buttons: Use solid colors with clear white font â€” no gradients."
...
- id: TASK-084
  ...
  title: "Dark mode â€” comprehensive pass on remaining hardcoded light colors"
...
- id: TASK-085
  ...
  title: "Creator summaries â€” add sticky positioning to power/technique/item creators"
  ...
  description: |
    ...
    and item creators do NOT â€” their summaries scroll away. Add `self-start sticky top-24`
...
- id: TASK-086
  ...
  title: "Full recovery â€” filter feat resets by recovery type"
...
- id: TASK-087
  ...
  title: "Remove dead code â€” unused imports and deprecated definitions"
  ...
  description: |
    ...
    1. library-section.tsx: imports ChevronDown, ChevronUp from lucide-react â€” never used

    2. proficiencies-tab.tsx: imports ChevronUp, ChevronDown from lucide-react â€” never used
...
- id: TASK-088
  ...
  title: "Fix chevron layout shift â€” use single icon with rotation"
  ...
  description: |
    ...
    1. filter-section.tsx: lines 96-106 â€” conditional ChevronUp/ChevronDown

    2. creature-stat-block.tsx: line 275 â€” conditional ChevronUp/ChevronDown

    3. list-components.tsx: line 66 â€” conditional chevrons (lower priority)
...
- id: TASK-089
  ...
  title: "Power/Technique/Item creator modals â€” unify LoadFromLibraryModal with shared patterns"
...
- id: TASK-090
  ...
  title: "Codebase health audit â€” dead code removal, deduplication, shared component unification, best practices"
...
- id: TASK-091
  ...
  title: "Extract shared useSort hook â€” eliminate 20+ duplicate toggleSort/handleSort implementations"
  ...
  description: |
    ...
    **Form A â€” standalone function (5 instances):**
    ...
    **Form B â€” inline setSortState (15+ instances):**
    ...
    **Solution:** Create a `useSort` hook in `src/hooks/use-sort.ts` that returns:
    ...
    - `sortState` â€” the current `SortState`

    - `handleSort(col)` â€” the toggle handler (pass directly to ListHeader onSort)

    - `sortItems(items)` â€” generic sort function using localeCompare
...
- id: TASK-093
  ...
  description: |
    ...
    1. item-list.tsx:231 â€” `className={\`space-y-4 ${className}\`}`

    2. tag-filter.tsx:46 â€” `className={\`filter-group ${className}\`}`

    3. select-filter.tsx:28 â€” `className={\`filter-group ${className}\`}`

    4. ability-requirement-filter.tsx:58 â€” `className={\`filter-group ${className}\`}`

    5. checkbox-filter.tsx:32 â€” `className={\`filter-group ${className}\`}`

    6. chip-select.tsx:42 â€” `className={\`filter-group ${className}\`}`

    7. codex/page.tsx:1454 â€” inline chip styling template literal

    8. item-card.tsx:258 â€” conditional ternary without cn()

    9. about/page.tsx:218 â€” transition class ternary without cn()

    

    For all: import cn from '@/lib/utils' and replace template literals.

    Items 2-6 are all the same pattern in filter components â€” batch fix.
...
- id: TASK-094
  ...
  description: |
    ...
    1. notes-tab.tsx:264 â€” Fall damage roll button
    ...
    2. dice-roller.tsx:189 â€” Roll button
    ...
    3. encounter-tracker/page.tsx:1291 â€” Add condition button
    ...
    4. item-creator/page.tsx:1399 â€” Add property button
    ...
    5. power-creator/page.tsx:1543 â€” Add part button
...
- id: TASK-095
  ...
  description: |
    ...
    1. item-list.tsx:241 â€” search input with icon overlay
    ...
    2. ability-requirement-filter.tsx:75 â€” number input for max value
...
- id: TASK-096
  ...
  description: |
    ...
    NOTE: This is a large refactor. Do incrementally â€” one file at a time.
...
- id: TASK-097
  ...
  title: "Unify filter component className patterns â€” extract filter-group class"
...
- id: TASK-098
  ...
  title: "Fix dark mode contrast and missing variants â€” audit follow-up"
...
- id: TASK-099
  ...
  title: Campaigns â€” return to Join tab after creating character
...
- id: TASK-100
  ...
  title: Campaigns â€” real-time updates via Firestore onSnapshot
...
- id: TASK-101
  ...
  title: Archetype prof slider â€” hide unless pencil clicked; show simple values otherwise
...
- id: TASK-102
  ...
  title: Encounter Tracker â€” add creatures from library (auto HP/EN, quantity)
...
- id: TASK-103
  ...
  title: Encounters hub â€” rename to Encounters; list/create/filter/search/sort
...
- id: TASK-106
  ...
  acceptance_criteria:
    ...
    - Set DS (default 10 + â€” party level)
...
- id: TASK-108
  ...
  title: Campaign integration â€” add characters from campaigns to encounters
...
- id: TASK-110
  ...
  description: |
    ...
    Ensure delete (X) button for weapons and armor works in character sheet. Feedback indicated pencil icon useless for feat deletionâ€”verify feat delete works; weapons/armor use onDelete (X) not pencil.
...
- id: TASK-115
  ...
  description: |
    ...
    Ensure all add-X modals (add feat, power, technique, armament) use shared Modal + ListHeader + GridListRow. No inline custom list UIs. TASK-068 unified creature creator modalsâ€”verify consistency.
...
- id: TASK-135
  ...
  title: Admin Codex UI polish â€” consistent design
...
- id: TASK-137
  ...
  title: Admin Save to library â€” public vs private toggle in creators
...
- id: TASK-143
  ...
  notes: "Done 2026-02-07: ADMIN_SETUP.md â€” added migration/deploy steps, public library (planned) note. DEPLOYMENT_AND_SECRETS_SUPABASE.md â€” Phase 7 Vercel step-by-step, copy-paste SQL for Storage RLS."



- id: TASK-144

  title: Documentation migration audit â€” update all docs for Supabase stack
...
- id: TASK-145
  ...
  description: |
    ...
    Data no longer comes from Firebase RTDB â€” it comes from Prisma via use-codex. Rename: useRTDBFeats?useCodexFeats (remove alias), RTDBFeat?Feat, rtdb* vars?codex*, source:'rtdb'?'codex'. See DOCUMENTATION_MIGRATION_AUDIT.md section 1.
...
- id: TASK-152
  ...
  title: Audit skill encounter page â€” verify completeness vs feedback
...
- id: TASK-153
  ...
  title: Navbar â€” Move Campaigns to right of RM Tools, left of About
...
- id: TASK-154
  ...
  title: Admin Codex â€” Display "-" for feat level 0 in list
...
- id: TASK-155
  ...
  title: Admin Codex â€” List refresh after delete; unify UI with Codex
  ...
  notes: |
    ...
    Done 2026-02-09: (1) Fixed invalidateQueries â€” all admin tabs used wrong keys; useCodex* hooks use ['codex']. Updated AdminFeatsTab, AdminSpeciesTab, AdminSkillsTab, AdminTraitsTab, AdminPartsTab, AdminPropertiesTab, AdminEquipmentTab, AdminCreatureFeatsTab to invalidate ['codex']. (2) Unified Admin Feats with Codex Feats: FilterSection, ChipSelect, AbilityRequirementFilter, TagFilter, SelectFilter, SortHeader, same GridListRow with detailSections. Other tabs (Skills, Species, etc.) can be unified incrementally â€” same pattern.



- id: TASK-156

  title: Feat Editing â€” Ability dropdown (6 abilities + 6 defenses)
...
- id: TASK-157
  ...
  title: Feat Editing â€” Add all missing editable fields
...
- id: TASK-158
  ...
  title: Centralized codex data schema â€” AI reference doc
...
- id: TASK-159
  ...
  title: Admin Codex â€” Reduce input lag in edit mode
...
- id: TASK-160
  ...
  title: Admin Codex â€” Array fields use dropdowns, not raw IDs
...
- id: TASK-161
  ...
  title: Campaignâ€”Encounter attachment and "Add all Characters"
...
- id: TASK-164
  ...
  title: Roll log consistency â€” styles, date display across encounter/campaign/sheet
  ...
  description: |
    ...
    Make roll log styles consistent across encounter tab (roll log campaign mode), character sheet (campaign mode), and campaign page. Fix roll date display â€” most show "unavailable" for the date. Use single RollEntryCard and shared formatting.
...
- id: TASK-167
  ...
  title: Character visibility â€” public link, campaign-only, private?campaign on join
...
- id: TASK-168
  ...
  title: Character-derived content visibility â€” library items view-only for viewers
...
- id: TASK-169
  ...
  title: Admin Feats â€” remove prereq_text and rely on req_desc
...
- id: TASK-170
  ...
  title: Admin Codex â€” unify Skills, Parts, Properties, and Equipment tabs with Codex layout
...
- id: TASK-171
  ...
  title: Admin Skills â€” base skill dropdown resolves base_skill_id
  ...
  notes: |
    ...
    Done 2026-02-16 (verified). Admin Skills modal already has Base skill select with base skill names (baseSkillOptions, "Any", "â€” None"); openEdit resolves base_skill_id to name; handleSave resolves baseSkillName to base_skill_id (blank=>undefined, "Any"=>0).



- id: TASK-172

  title: Admin Skills â€” expose additional description fields
...
- id: TASK-173
  ...
  title: Skills â€” render extra descriptions as expandable chips in item cards
...
- id: TASK-174
  ...
  title: Codex schema â€” add Use column and align fields
...
- id: TASK-175
  ...
  title: Codex skills â€” remove invalid trained_only field
...
- id: TASK-176
  ...
  title: Codex seeding â€” wipe and reseed from canonical CSVs
...
- id: TASK-177
  ...
  title: Codex schema usage audit â€” IDs, equipment, mechanic properties
  ...
  description: |
    ...
    Audit the codebase for any discrepancies between the updated codex schema and actual usage. Focus on: feat.skill_req being treated as names instead of IDs; species skills/traits/flaws/characteristics treated as names instead of IDs; any lingering references to â€”itemsâ€” where the canonical collection is now â€”equipmentâ€” / codex_equipment; and ensuring properties.mechanic is available wherever needed.
...
- id: TASK-178
  ...
  title: Armament creator â€” hide mechanic properties from add-property lists
...
- id: TASK-179
  ...
  title: Feat skill_req â€” convert to ID-based everywhere
  ...
  acceptance_criteria:
    ...
    - Requirement-checking logic (e.g. in feats-step and add-feat-modal) correctly maps feat.skill_req IDs to the characterâ€”s skill bonuses via ID?name resolution
...
- id: TASK-180
  ...
  title: Species skills/traits/flaws/characteristics â€” enforce ID-based usage
...
- id: TASK-181
  ...
  title: Admin Skills â€” ability multi-select aligned with schema
...
- id: TASK-182
  ...
  title: Admin Equipment â€” align fields with codex_equipment schema
...
- id: TASK-189
  ...
  title: Fix save/display pipeline â€” item auto-gen properties, technique actionType, enrichment
...
- id: TASK-183
  ...
  title: Admin Parts â€” edit defense targets
...
- id: TASK-190
  ...
  title: Admin Creature Feats â€” level, requirement, mechanic flags
  ...
  acceptance_criteria:
    ...
    - Codex API (`/api/codex`) returns the new fields in the creatureFeats payload in a way that is compatible with the creature creatorâ€”s feat points calculation
...
- id: TASK-191
  ...
  title: Admin Equipment â€” currency, category, and type alignment
  ...
  acceptance_criteria:
    ...
    - The equipment listâ€”s cost column reflects the true currency value from the codex row (no more showing 0 in the modal when the list shows a non-zero cost)
...
- id: TASK-192
  ...
  title: Admin Properties & Parts â€” mechanic/duration flags, percentage display, option chips
  ...
  acceptance_criteria:
    ...
    - AdminPropertiesTab type dropdown uses only the canonical property types ("Armor", "Shield", "Weapon") and initial selection reflects the propertyâ€”s actual type (no "general" default)
...
- id: TASK-193
  ...
  title: Admin Traits & Species â€” flaw/characteristic flags, sizes, trait chips
  ...
  acceptance_criteria:
    ...
    - Species edit modal uses trait selections (species_traits, ancestry_traits, flaws, characteristics) that render as expandable chips in the expanded species row so RMs can click and read each traitâ€”s description without leaving the list
...
- id: TASK-194
  ...
  title: Admin Skills & Feats â€” base skill display and filter â€”Allâ€” options
  ...
  acceptance_criteria:
    ...
    - AdminSkillsTab Base Skill column shows the correct base skill name for all skills with a valid base_skill_id (including id 0 ? â€”Anyâ€”), falling back to "-" only when there truly is no base skill

    - Editing an existing sub-skill in AdminSkillsTab pre-selects the appropriate base skill (or â€”Anyâ€”) in the Base skill dropdown based on base_skill_id

    - The Skill Type SelectFilter in AdminSkillsTab has a single clear way to show â€”all skillsâ€” (e.g., placeholder only or explicit option only), eliminating duplicate â€”All Skillsâ€” entries

    - The Feat Type and State Feats filters in AdminFeatsTab likewise avoid duplicate â€”Allâ€”/â€”All Featsâ€” options while preserving the ability to filter by archetype/character and state feats
...
- id: TASK-205
  ...
  notes: |
    ...
    cleanForSave now saves feats as { id, name, currentUses } only â€” description/maxUses/recovery
...
- id: TASK-206
  ...
  notes: |
    ...
    cleanForSave now saves powers as { id, name, innate } â€” name kept for backward compat lookup,
...
- id: TASK-207
  ...
  notes: |
    ...
    cleanForSave now saves techniques as { id, name } objects â€” name kept for backward compat,
...
- id: TASK-208
  ...
  notes: |
    ...
    cleanForSave now strips ability, baseSkillId, category from saved skills â€” only keeps
...
- id: TASK-209
  ...
  notes: |
    ...
    cleanForSave now saves equipment items as { id, name, equipped?, quantity? } â€” strips
...
- id: TASK-217
  ...
  notes: |
    ...
    Fully completed in Phase 4 (TASK-203â€”210). cleanForSave now strips all derived data:
...
- id: TASK-220
  ...
  notes: |
    ...
    Idempotent â€” already-lean characters pass through unchanged.
...
- id: TASK-221
  ...
  description: |
    ...
    b) PROGRESSION_CREATURE: Skill points at L1 (5), skill points per level (3),
       ...
       base HP/EN pool (26), base training points (22), TP per level (2) â€” same as characters,
    ...
    c) ABILITY_RULES: Min (-2), max starting (3), hard cap characters (10),
       ...
       hard cap creatures (20), no level cap, cost increase threshold (4 â€” cost doubles at 4+),
...
- id: TASK-224
  ...
  notes: |
    ...
    Skipped GameRulesProvider (not needed â€” React Query handles caching globally).
...
- id: TASK-233
  ...
  notes: |
    ...
    Zero new TypeScript errors â€” all existing call sites work unchanged (optional param).
...
- id: TASK-235
  ...
  title: About page â€” dice carousel redesign (center, 7 dice, wrap, no brackets)
...
- id: TASK-236
  ...
  title: Skill encounter â€” Successes UI, DS post-roll, RM bonus, additional success/failure
...
- id: TASK-237
  ...
  title: Combat tracker â€” surprised checkbox, initiative select-all, delete turn, auto-sort
...
- id: TASK-238
  ...
  title: "Codebase Audit 2026-02-13 â€” Phase 1-3 implementation"
...
- id: TASK-239
  ...
  title: "Audit Phase 2 â€” Complete design token migration (blue/green/red/amber ? tokens)"
...
- id: TASK-240
  ...
  title: "Audit Phase 2 â€” Standardize modal/error/loading patterns"
...
- id: TASK-241
  ...
  title: "Audit Phase 1 â€” Add Zod input validation to API routes"
...
- id: TASK-242
  ...
  title: "Audit Phase 1 â€” Add rate limiting to API routes"
...
- id: TASK-243
  ...
  title: "Audit Phase 4 â€” Add loading.tsx and error.tsx route handlers"
...
- id: TASK-244
  ...
  title: "Audit Phase 5 â€” Add missing Prisma indexes"
...
- id: TASK-245
  ...
  title: "Audit Phase 6 â€” Public character view page (frontend)"
  ...
  notes: "Done 2026-02-13: The character sheet page already supported public viewing â€” API returns character + libraryForView for non-owners. Removed the auth redirect that was blocking unauthenticated access. isOwner controls edit mode. getOwnerLibraryForView returns the owner's powers/techniques/items for viewers."



- id: TASK-246

  title: "Audit Phase 6 â€” Character creator skill auto-save on tab switch"
...
- id: TASK-247
  ...
  title: "Audit Phase 4 â€” Optimize React Query stale times for codex data"
...
- id: TASK-248
  ...
  acceptance_criteria:
    ...
    - No behavioral changes â€” all existing functionality preserved
...
- id: TASK-250
  ...
  title: "Character creator â€” Species modal skill description clear when switching species"
...
- id: TASK-251
  ...
  title: "Character creator â€” Step check mark when navigating away with 'Continue anyway'"
...
- id: TASK-252
  ...
  title: "Unify add power/technique modals â€” character creator and creature creator"
  ...
  notes: "Done 2026-02-17: powers-step.tsx â€” added POWER_MODAL_COLUMNS/POWER_GRID_COLUMNS and TECHNIQUE_MODAL_COLUMNS/TECHNIQUE_GRID_COLUMNS; availablePowers/availableTechniques now build columns (Action, Damage, Area / Weapon, Parts); passed columns and gridColumns to both UnifiedSelectionModals. creature-creator/transformers â€” power stats now Action, Damage, Area; technique stats Weapon, Parts. creature-creator/page â€” power/technique SelectableItems use ['Action','Damage','Area'] and ['Weapon','Parts']; modal columns/gridColumns aligned with add-library-item."



- id: TASK-253

  title: "Finalize step â€” display ability names as full text (min 3-letter)"
...
- id: TASK-254
  ...
  title: Creators â€” description/option contrast + dropdown dark mode
...
- id: TASK-255
  ...
  title: Accessibility audit â€” color contrast WCAG 2.1 AA
...
- id: TASK-256
  ...
  title: Species height/weight/lifespan â€” API mapping and display everywhere
...
- id: TASK-257
  ...
  title: Skill admin â€” governing ability is abilities-only (not defenses)
...
- id: TASK-258
  ...
  title: Public codex â€” add Traits tab and Advanced tabs toggle
...
- id: TASK-259
  ...
  title: Public vs admin codex unification â€” layouts, chips, descriptions
...
- id: TASK-260
  ...
  title: Edit property â€” option cost labels (IP/TP/c) and larger description field
...
- id: TASK-261
  ...
  title: Edit equipment â€” category dropdown with add-new and existing list
  ...
  notes: "Done 2026-02-18: Category is a select with â€” None â€”, all existing equipment categories, and 'Add new category...'; when Add new is selected, text input appears to type new category; categoryIsNew state keeps UX correct on edit."



- id: TASK-262

  title: Single list header component â€” migrate SortHeader views to ListHeader
...
- id: TASK-263
  ...
  title: Shared creator load helper â€” useCreatorLoad(type, options)
...
- id: TASK-264
  ...
  title: Modal unification â€” implement audit recommendations (list modals)
  ...
  notes: "Done 2026-02-20: Phase 1 â€” UnifiedSelectionModal, LoadFromLibraryModal, AddFeatModal, AddLibraryItemModal, AddSkillModal use EmptyState/LoadingState; AddLibraryItemModal ListHeader wrapper removed; AGENT_GUIDE list modal layout added. Phase 2 â€” AddFeatModal and AddSkillModal use FilterSection; padding standardized (px-4 py-3 border-border-light bg-surface-alt). Phase 3 â€” LoadCreatureModal refactored to ListHeader+GridListRow+SearchInput+EmptyState/LoadingState. useModalListState hook added; used in LoadFromLibraryModal and LoadCreatureModal. npm run build passes."
...
- id: TASK-266
  ...
  title: Mobile-first UX overhaul (Phases 2â€”4)
  ...
  notes: |
    ...
    Phase 2 completed 2026-02-22: Character sheet page â€” below md, horizontal side-scroll (snap-x snap-mandatory) with 4 panels (Abilities & Defenses, Skills, Archetype & Attacks, Library); each panel full-width, scroll-snap-align start, vertical scroll inside panel. Desktop layout unchanged (hidden md:block). SheetHeader: right column w-full min-w-0 on mobile, AP+Health/Energy stack on xs (flex-col sm:flex-row). SheetActionToolbar: on mobile fixed bottom-4 left-4 right-4, flex-row justify-center; on md+ fixed top-24 right-4, flex-col. npm run build passes.

    Phase 3 completed 2026-02-22: CreatorLayout â€” main content order-2 lg:order-1, sidebar order-1 lg:order-2 (sidebar first on mobile); min-w-0 on both. Creator tab bar â€” flex-nowrap md:flex-wrap, overflow-x-auto, scrollbar-thin, step buttons flex-shrink-0. Library/Codex â€” mode toggle and TabNavigation wrapped in min-w-0 divs.

    Phase 4 completed 2026-02-22: Encounters â€” Create Encounter modal fullScreenOnMobile, type grid grid-cols-1 sm:grid-cols-3, top bar min-w-0. Campaigns â€” TabNavigation and main content min-w-0. My-account â€” PageContainer and header div given min-w-0. Rules, resources, privacy, terms use PageContainer; admin tables documented. npm run build passes.
...
- id: TASK-274
  ...
  title: Creature Creator â€” Show feat point cost for damage modifiers, senses, movement, condition immunities
  ...
  acceptance_criteria:
    ...
    - Damage Modifiers section: show feat point cost per type (resistance, immunity, weakness) â€” e.g. label or chip like "+1 pt" / "-1 pt" â€” before adding (in dropdown or nearby) and on each added chip/row.
    ...
    - Use creature feat codex data (feat_points) and CREATURE_FEAT_IDS / SENSE_TO_FEAT_ID / MOVEMENT_TO_FEAT_ID for costs; summary panel already computes mechanical feat points â€” surface costs in UI.
...
- id: TASK-275
  ...
  title: Creature Creator â€” Use AddSkillModal and AddSubSkillModal instead of skills dropdown
...
- id: TASK-276
  ...
  title: Creature Creator â€” Separate Add Feat and Add Negative Feat modals
...
- id: TASK-277
  ...
  title: Creature Creator â€” Power/technique/armament modals and lists show parts, properties, options as chips; use site-wide display logic
  ...
  acceptance_criteria:
    ...
    - Creature creator displayed lists (Powers, Techniques, Armaments sections): each row expandable with description, parts/properties as chips, area/range/damage/requirements in expanded view â€” same structure as library-section and character creator steps (GridListRow with detailSections, chips).
...
- id: TASK-278
  ...
  title: Fix username change â€” new username replaced by Player### instead of kept
...
- id: TASK-281
  ...
  title: Encounters â€” add list columns (name, type, status) for filtering
...
- id: TASK-282
  ...
  title: Characters â€” add list columns (name, level, archetype_name, etc.); keep data JSONB
  ...
  description: |
    ...
    Long-term hybrid for characters: add columns to `characters` for list/filter/sort without parsing JSONB â€” name, level, archetype_name, ancestry_name, status, visibility (plus existing id, user_id, updated_at). Keep `data` (JSONB) for the full document. On every create/update, write these scalars from the document into columns. SQL: ADD COLUMN + backfill from data; API GET list selects columns (optionally still fallback from data for legacy rows); POST/PATCH write columns from payload. Benefits: list/filter/sort by level or name; future "characters level 5+", "by archetype"; analytics.
...
- id: TASK-283
  ...
  title: Campaign rolls â€” add list columns (character_id, user_id, type, title); keep data JSONB
...
- id: TASK-284
  ...
  title: Species steps â€” deduplicate list items (flaws, traits, characteristics) when mixed
...
- id: TASK-285
  ...
  title: Species steps â€” sticky Continue button
...
- id: TASK-286
  ...
  title: Power creator â€” support multiple damage types per power
...
- id: TASK-287
  ...
  title: Creators â€” explicit energy (EN) display per item
...
- id: TASK-289
  ...
  title: Official library â€” fix save for powers, techniques, armaments
...
- id: TASK-290
  ...
  title: Range display â€” consistent spacing for powers and armaments across views
...
- id: TASK-293
  ...
  description: |
    ...
    Add CRAFTING category to core_rules table with general crafting table, successes table, enhanced crafting table, consumable enhanced table, multiple-use energy table, and multipliers (crafting cost 75%, consumable time â€”, upgrade cost, etc.). Add Crafting tab to admin core rules editor for editing these values.
...
- id: TASK-296
  ...
  title: Creator resource colors â€” shift TP to lime and keep IP/C distinct
...
- id: TASK-311
  ...
  description: |
    ...
    selection auto-filters the list to feats the character qualifies for â€” using the exact same
  ...
  acceptance_criteria:
    ...
    - Feat qualification reuses a single shared module (`checkFeatRequirements`) â€” the creator Feats step and character-sheet Add Feat modal use the same module (no duplicated logic).
...
# RECONCILIATION TASKS â€” Created 2026-02-06 from full codebase audit
...
# Campaignâ€”Encounter, Roll Log, Character Visibility (TASK-161+)
...
# ADMIN CORE RULES â€” Database-Driven Game Configuration
...
#   NOTE: TASK-195 CANCELLED (code correct, GAME_RULES.md was wrong â€” fixed)

#   NOTE: TASK-198, TASK-199 owner-resolved â€” moved to TIER 1
...
## Appended 2026-07-15 (workflow slim â€” 79 tasks from active queue)



- id: TASK-473

  title: Admin path â€” recommended innate powers + eligibility validation
  ...
  description: |
    ...
    creation enforces full innate eligibility (REALMS Appendix G / â€”5.11): Energy = Innate

    Threshold; Basic/Reaction only; no healing/energy-gain parts; combined recommended innate

    Energy costs fit Innate Energy (Threshold â€” Pools from calculateArchetypeProgression â€” L1
  ...
  acceptance_criteria:
    ...
    - Publish/save validation blocks any recommended innate that fails Appendix G eligibility
      ...
      (Energy > Innate Threshold, nonâ€”Basic/Reaction action type, healing/energy-gain parts)
  ...
  notes: |
    ...
    Owner 2026-07-15: â€”other eligibility rules enforced on admin path creation (another task).â€”
    ...
    approved) â€” `level1_innate_powers` TEXT live. Seed recommended innates via admin when ready.



- id: TASK-472

  title: Guided innate powers â€” threshold gate + fully use Innate Energy
  ...
  description: |
    ...
    (Threshold â€” Pools â€” L1 Power 16 / PM 6), matching the character sheet â€” NOT
  ...
  acceptance_criteria:
    ...
    - Continue blocked until remaining Innate Energy is 0 (fully used) â€” intentional override of

      â€”5.8 optional Continue for the innate track only; regular powers stay optional.

    - Visible Innate Energy spent/remaining uses shared PointStatus (not a fork of

      LoadoutBudgetBar Currency â€” TP remains on regular powers only).
    ...
    - DEV-V-013 tests; update REALMS â€”5.8; npm run build.
...
- id: TASK-471
  ...
  title: Guided powers â€” separate innate vs regular L1 lists
  ...
  description: |
    ...
    Power users (Power / Powered-Martial): split the powers step into distinct curated L1 lists â€”

    path recommended innate powers vs path recommended (regular) powers â€” not one mixed grid.
    ...
    or powerIds + innate flags â€” today only powerIds/techniqueIds).
  ...
  acceptance_criteria:
    ...
    - Soft (after TASK-463): L2 See more for innate vs regular opens the correct modal list;
      ...
      L2 picks promote onto the correct L1 list per TASK-458 pattern â€” do not block L1 dual-list

      ship on this.

    - Update REALMS â€”5.8 (innate vs regular; powered-martial clarity); FEATURE_INDEX; DEV-V-013;
...
- id: TASK-470
  ...
  title: Guided powers/techniques L1 â€” Loadout card + desc-chip parity
  ...
  description: |
    ...
    mechanic facts as desc chips behind See moreâ€”, same GuidedChoiceCard /

    GuidedEquipmentFactChips / DescriptorChipWithTip patterns.

    Desc chips: Action Type value-only (â€”Quick Actionâ€”, not â€”Action Type Quick Actionâ€”) via

    actionTypeFactChip / chip helper â€” do NOT blindly change formatActionTypeFact if GLR/ListHeader
  ...
  acceptance_criteria:
    ...
    - Power/technique GuidedChoiceCards match weapon/armor disclosure anatomy: titleMeta budgets;
      ...
      mechanic chips (incl. Action Type) in expandedExtra / See more â€” not title-adjacent Action

      Type; nothing under the disclosure row.

    - Desc chips for Action Type show capitalized value only (â€”Quick Actionâ€”, â€”Basic Reactionâ€”);

      ListHeader / column cells may keep â€”Action Typeâ€” as the column label; update GAME_RULES

      mechanic-labels table + AGENT_GUIDE to distinguish chip vs column.

    - Training Points remain title-adjacent / LoadoutBudgetBar (TASK-456 â€” verify no regression).

    - Energy may appear as a compact fact chip or tagline â€” no parallel formatters outside
  ...
  notes: |
    ...
    Today power-technique-display puts Action Type + TP in titleChips with no See more expand â€”
...
- id: TASK-469
  ...
  title: Characters list â€” square portraits, drop search/ListHeader
  ...
  developer_test_plan: |
    ...
    Suite DEV-V-022 T001â€”T003 â€” see BUILD_VALIDATION.md
...
- id: TASK-468
  ...
  notes: |
    ...
    Parallel with TASK-464â€”466. SkillRow table variant already used this look inline;
...
- id: TASK-467
  ...
  description: |
    ...
    (`- n +`), not push the row aside. Prefer quantity-first â€” increasing from 0 selects;

    decreasing to 0 deselects â€” without forking a guided-only modal.
...
- id: TASK-464
  ...
  title: Compact-facts polish â€” Ability Requirement, Damage, suppress redundancies
  ...
  description: |
    ...
    Base, â€”); L1 named property chips are name-only (no TP on those desc chips). Armor gets
  ...
  notes: |
    ...
    Foundation for TASK-465â€”468. No parallel formatters. Codices: no live DB writes.



- id: TASK-463

  title: Guided powers/techniques L2 â€” UnifiedSelectionModal + energy filter
  ...
  description: |
    ...
    REALMS â€”3.1 / â€”5.8: See more options must open a Layer 2 modal (GridListRow +
  ...
  acceptance_criteria:
    ...
    - See more options for powers and techniques opens UnifiedSelectionModal with GridListRow â€”
    ...
    - fullScreenOnMobile on modal; update REALMS â€”5.8 (replace in-step panel wording);
  ...
  notes: |
    ...
    deferred; browse panel removal is AC. Prefer calculateMaxEnergy(18, ...) over hard-cap â€”
    ...
    calculateMaxEnergy(18,â€”) with >20 fallback.
...
- id: TASK-462
  ...
  title: Guided Your Hero reveal â€” cherry-on-top finalize overhaul
  ...
  developer_test_plan: |
    ...
    Suite DEV-V-013 T015, T045 â€” see BUILD_VALIDATION.md
  ...
  acceptance_criteria:
    ...
    - Age/height/weight placeholders show species adulthoodâ€”lifespan and average cm/kg when known.
  ...
  notes: |
    ...
    Product overview â€”5.10. Owner feedback 2026-07-15. Revisit prior steps via chapter rail only.
...
- id: TASK-454
  ...
  title: Shared compact fact grammar â€” semantic chips, tooltips, capitalization
  ...
  description: |
    ...
    changing guided Loadout. Today equipment owns one-off labels such as â€”Handedness Two-handed,â€”

    â€”Damage X,â€” and â€”Strength attack,â€” while property descriptions can become expandable chips.
  ...
  acceptance_criteria:
    ...
    - Document the column-versus-chip rule: keep labeled columns in dense comparison views; when
      ...
      compacting a fact into a chip, use natural self-describing language rather than â€”Header: value.â€”
    ...
    - Canonical weapon examples are â€”Ability Requirement X+,â€” â€”Two-handed,â€” â€”XdY Type damage,â€”

      â€”Strength Weapon,â€” â€”Agility Weaponâ€” for Finesse, and â€”Acuity Weaponâ€” for ranged non-Finesse.
    ...
    - Non-mechanic properties render as non-expanding descriptor chips (for example â€”Grazeâ€”) with
...
- id: TASK-455
  ...
  title: Guided card regressions â€” No Flaw height and Archetype Ability pill collision
  ...
  acceptance_criteria:
    ...
    - Touch targets remain at least 44â€”44px and semantic design tokens pass light/dark contrast.
  ...
  evidence: |
    ...
    No Flaw alone on a row shrank despite cardCollapsed; (2) TASK-452 wrap on â€”Archetype Abilityâ€”
...
- id: TASK-456
  ...
  title: Guided Loadout budgets â€” optional picks, Currency and Training Points
  ...
  acceptance_criteria:
    ...
    - Reconcile REALMS â€”5.7 / â€”5.8 and GAME_RULES: remove â€”Training Points stay in Layer 2â€” and

      â€”included in your pathâ€” claims where they conflict with visible constrained selection.
...
- id: TASK-457
  ...
  title: Guided weapon and armor cards â€” disclosure-safe fact layout
  ...
  acceptance_criteria:
    ...
    - Finesse is represented by â€”Agility Weaponâ€” rather than a duplicate Finesse mechanic chip;

      ranged non-Finesse uses â€”Acuity Weaponâ€”; ordinary melee uses â€”Strength Weapon.â€”

    - Other named properties appear as descriptor chips with an accessible tooltip info trigger,

      not â€”Property: descriptionâ€” text and not click-to-expand chips.
...
- id: TASK-458
  ...
  title: Guided catalog picks â€” return selected items as visible cards
  ...
  developer_test_plan: |
    ...
    Suite DEV-V-013 T043, T046 â€” see BUILD_VALIDATION.md
  ...
  acceptance_criteria:
    ...
    - Path recommendations may use one subtle descriptor when differentiation is necessary, but
      ...
      avoid reintroducing noisy â€”Path pickâ€” badges; selected state remains the primary signal.
...
- id: TASK-459
  ...
  title: Guided chapter terminology â€” Loadout chapter and Equipment screen
  ...
  description: |
    ...
    Make the chapter name â€”Loadoutâ€” because it includes weapons, armor, Equipment, powers, and

    techniques. Rename the current Adventuring Gear/Gear phase to â€”Equipmentâ€” everywhere users see

    it, while preserving accurate internal types until a safe mechanical rename is warranted.

  acceptance_criteria:

    - Chapter rail, headings, review/reveal, help, and completion copy consistently use â€”Loadout.â€”

    - The gear phase and its add modal consistently use â€”Equipmentâ€”; no user-facing â€”Adventuring

      Gearâ€” or ambiguous bare â€”Gearâ€” remains in the guided flow.
...
- id: TASK-460
  ...
  title: Guided Equipment screen â€” card copy, quantity, and add-modal polish
  ...
  developer_test_plan: |
    ...
    Suite DEV-V-013 T024, T047 â€” see BUILD_VALIDATION.md
  ...
  description: |
    ...
    description-as-â€”Useâ€” chips, normalize Currency/Training Points placement, and redesign quantity

    selection in both cards and the add modal so quantity is shown once with clear shared controls.

  acceptance_criteria:

    - Equipment card description appears once; no generated â€”Use [repeated description]â€” chip.
    ...
    - Selected quantity is displayed once per item. The visible stepper label is â€”Quantityâ€”; the
    ...
    - Audit and improve the L2 add-modal quantity composition using shared ValueStepper/control
      ...
      patterns: clear grouping, =44â€”44px targets, no cramped or duplicate count, and immediate totals.
    ...
    - â€”Add all recommended Equipmentâ€” and individual quantities still respect Currency/Training
...
- id: TASK-452
  ...
  title: AbilityScoreGrid â€” mobile labels, Archetype Ability pill, edit layout
  ...
  description: |
    ...
    which spills outside the tile. Customize/edit mode packs 44px â€” steppers into the same ~75px

    cells. Same grid is reused on abilities display, customize, and reveal summary â€” fix once in
  ...
  acceptance_criteria:
    ...
    - Edit mode at ~360px: â€” controls remain =44px and do not collide (stack, 2-col, or list layout

      below sm â€” not forced into 3-col with horizontal 44px steppers).
...
- id: TASK-453
  ...
  title: Guided creator â€” mobile completion hints + residual density polish
  ...
  developer_test_plan: |
    ...
    DEV-V-013-T038 â€” completion hints visible above Back/Continue at ~360px; mid-footer on sm+.
  ...
  acceptance_criteria:
    ...
    - On viewports < sm, users still see relevant completion/progress (points left, pick counts,
      ...
      etc.) either in the footer or as an in-step banner/status â€” not silent.
...
- id: TASK-451
  ...
  title: Guided creator â€” retain picks, skills L2 browse, secondary ability pill
...
- id: TASK-448
  ...
  title: Guided creator â€” detail Select/Close + chapter-jump first screen
  ...
  notes: |
    ...
    Audit 2026-07-15: REALMS â€”3.1 updated (More details open ? select; footer Select OK);
...
- id: TASK-447
  ...
  title: Guided equipment â€” drop phase bar, PointStatus Currency, card chips + cost fix
  ...
  notes: |
    ...
    Owner 2026-07-15 â€” agree L1/L2 should spell game terms; dense L3 may abbreviate.



- id: TASK-446

  title: Guided equipment L1 â€” card-first simplify + orphan selection fix
  ...
  description: |
    ...
    Align equipment L1 with feats/path: drop â€”Your selectionâ€” summary chips; quieter phase
  ...
  acceptance_criteria:
    ...
    - No â€”Your selectionâ€” summary strip on weapon/armor/gear L1.
  ...
  evidence: |
    ...
    FEATURE_INDEX / AGENT_GUIDE / REALMS â€”5.7 / GUIDED_SPEC.

  notes: |

    Owner 2026-07-15 â€” equipment felt glitchy/cluttered vs other guided steps.



- id: TASK-445

  title: Stable expand toggle â€” expand without moving the click target (sitewide)
  ...
  developer_test_plan: |
    ...
    Suite DEV-V-021 T001â€”T003 â€” see BUILD_VALIDATION.md
  ...
  description: |
    ...
    offenders. Prefer growing content and pushing siblings while the opened controlâ€”s origin

    (especially vertical) stays put.

  acceptance_criteria:

    - Document â€”stable expand toggleâ€” in AGENT_GUIDE (and brief MOBILE_UX note): opened

      controlâ€”s click target does not shift under the cursor; siblings may move.
    ...
    - fullWidthWhenExpanded (or replacement pattern) no longer relocates the expanded chipâ€”s
  ...
  evidence: |
    ...
    DEV-V-021 T001â€”T003. Build passes.  notes: |
...
- id: TASK-444
  ...
  title: Guided powers/techniques â€” visible confirm + Layer 2 browse (â€”3.1 / â€”5.8)
  ...
  description: |
    ...
    Align guided powers/techniques with Layer 1 choice principle (â€”3.1): user should see and
    ...
    UnifiedSelectionModal as appropriate. REALMS â€”5.8 gap from 2026-07-15 vision reconcile.
  ...
  acceptance_criteria:
    ...
    - GuidedLayerNav â€”See more optionsâ€” opens filtered browse; â€”Back to recommendationsâ€” returns to L1.
  ...
  notes: |
    ...
    is superseded by TASK-463 â€” do not extend the browse panel.
...
- id: TASK-441
  ...
  title: Guided ancestry traits â€” shared limited-uses notice (like feats)
  ...
  developer_test_plan: |
    ...
    DEV-V-013-T021 â€” Ancestry trait cards with uses_per_rec show uses notice when selected/expanded (same shell as feats).
...
- id: TASK-442
  ...
  title: Guided equipment â€” remove quick kits (FE + admin; DB migration proposed)
  ...
  developer_test_plan: |
    ...
    DEV-V-013-T004 updated (no kits); DEV-V-013-T022 â€” admin has no kit JSON field.
...
- id: TASK-443
  ...
  title: Guided equipment â€” phase visibility + weapon/armor/gear card remodel
...
- id: TASK-432
  ...
  title: Guided choice-card deep-dive â€” Phase 1 foundation (affordance + modal shell)
  ...
  developer_test_plan: |
    ...
    DEV-V-013-T016 â€” Path + Species More details opens modal without selecting; card click still selects.
  ...
  evidence: |
    ...
    option section; docs/naming in REALMS â€”5.0.1, AGENT_GUIDE, FEATURE_INDEX, guided-creator-copy.
  ...
  description: |
    ...
    Owner feedback 2026-07-15 (â€”Layer 2 Cardsâ€”): progressive disclosure on choice cards needs an

    explicit path from Layer 1 card ? information modal for that entity â€” opened only via a

    â€”More detailsâ€” control, never by selecting the card. Opening More details must not select;
    ...
    - Catalog Layer 2 = GuidedLayerNav â€”See more optionsâ€” / browse / UnifiedSelectionModal (existing).

    - Choice-card deep-dive = â€”More detailsâ€” on a GuidedChoiceCard ? GuidedEntityDetailModal (this epic).

    Do not reuse â€”See moreâ€” wording that opens catalog L2; prefer â€”More detailsâ€” / â€”View detailsâ€”.
    ...
    3) Product/docs: â€” progressive disclosure on cards in REALMS_PRODUCT_OVERVIEW; FEATURE_INDEX +
  ...
  acceptance_criteria:
    ...
    - Shell renders overview + N collapsible sections with placeholder/demo content in isolation
      ...
      smoke in guided only â€” prefer wiring both steps with empty sections deferred to 433/434).
  ...
  notes: |
    ...
    Prefer remodel-in-place of shared primitives over forking parallel â€”guided-onlyâ€” row components.
...
- id: TASK-433
  ...
  title: Guided choice-card deep-dive â€” Phase 2 species detail modal
  ...
  developer_test_plan: |
    ...
    DEV-V-013-T017 â€” Species More details: overview parity + trait/characteristic/flaw catalogs; selection independent.
  ...
  description: |
    ...
    â€” clean sections, readable type, not overwhelming. Size picker / draft mutation stay on the
    ...
    for clarity â€” full remodel of row chrome can land in TASK-435 if needed; Phase 2 must be usable).
  ...
  acceptance_criteria:
    ...
    - Species cards show â€”More detailsâ€”; opens modal; does not change selection.
  ...
  notes: |
    ...
    Depends on TASK-432. Do not block on perfect GridListRow column presets â€” TASK-435 unifies.
...
- id: TASK-434
  ...
  title: Guided choice-card deep-dive â€” Phase 3 path detail modal
  ...
  developer_test_plan: |
    ...
    DEV-V-013-T018 â€” Path More details: overview + feat/weapon/armor/loadout/power|technique catalogs; selection independent.
  ...
  description: |
    ...
    primary/secondary recommended abilities, recommended skills â€” well separated, readable.
  ...
  acceptance_criteria:
    ...
    - Path cards show â€”More detailsâ€”; opens modal; does not change path selection.
  ...
  notes: |
    ...
    and equipment-catalog-rows / feat helpers â€” remodel presentation, donâ€”t invent parallel data paths.



- id: TASK-435

  title: Guided choice-card deep-dive â€” Phase 4 shared option rows + remodel legacy surfaces
  ...
  developer_test_plan: |
    ...
    DEV-V-013-T019 â€” Shared DetailOptionList on species/path deep-dives + SpeciesRevealPanel granted + species-modal trait sections.
  ...
  description: |
    ...
    Goal: one shared â€”detail option rowâ€” toolkit for traits, feats, weapons, armor, powers,

    techniques â€” column stats appropriate per entity; used inside GuidedEntityDetailModal and
  ...
  acceptance_criteria:
    ...
    - At least one legacy surface (species-modal and/or SpeciesRevealPanel lists) remodeled to the
      ...
      same visual/interaction language â€” audit before/after; no behavior regression.
  ...
  notes: |
    ...
    unless leftover capacity â€” file follow-up TASK-### for additional entity deep-dives.



- id: TASK-436

  title: Guided deep-dive polish â€” path overview, tip bodies, labeled fact chips
  ...
  developer_test_plan: |
    ...
    DEV-V-013-T020 â€” Path overview polish + tip bodies + Name/Description-only option lists.
  ...
  description: |
    ...
    Owner polish after TASK-432â€”435: hide irrelevant path proficiency lines; Archetype Ability
...
- id: TASK-437
  ...
  title: Sitewide GridListRow â€” labeled fact chips when columns are omitted
  ...
  developer_test_plan: |
    ...
    DEV-V-016-T007 â€” Sheet Add Power columns + Range chip.

    DEV-V-016-T008 â€” Codex Equipment Damage / Dmg. Red. + Weight chip.

    DEV-V-016-T009 â€” Creator powers/techniques omitted fact chips.

    DEV-V-016-T010 â€” Creature creator Duration + armament fact chips.
  ...
  evidence: |
    ...
    DEV-V-016-T007â€”T010; npm run build passed after both phases.
...
- id: TASK-438
  ...
  title: Agent user-facing copy guide â€” game terms capitalization + preferred vocabulary
  ...
  description: |
    ...
    Soft guide only â€” do not over-constrain agent writing.
...
- id: TASK-439
  ...
  title: Sitewide user-facing copy audit â€” Realms terms + em dash + AI-artifact hygiene
  ...
  description: |
    ...
    Health/Energy vs inventing mana/HP jargon where Realms terms apply); remove em dashes (`â€”`)
    ...
    4) In-app UI not yet in copy modules (sheet, library, campaigns, creators, encounters) â€” grep
  ...
  acceptance_criteria:
    ...
    - Phases 2â€”3 copy modules + tooltip-text cleaned of em dashes and clear prefer/avoid violations
  ...
  evidence: |
    ...
    Keep-exceptions: developer comments; empty-field placeholder glyph `â€”`; dense creature/encounter

    HUD label HP (allowed abbr per GAME_RULES).

    Phases 2â€”3: guided-creator-copy em dashes removed; Base Health/Energy; Ability Bonuses/Points;
    ...
    labels, AdminPartsTab â€”%, creature-creator "Damage Modifiers" ? Resistances/Weaknesses/Immunities).

    Re-scan: 0 Ability Scores / Difficulty Class / Skill Check / Saving Throw / Armor Class /

    Damage Modifiers in UI tree; remaining em dashes are comments or `â€”` placeholders only.
  ...
  developer_test_plan: |
    ...
    Suite DEV-V-020 T001â€”T003 â€” landing + guided chooser + roll-log Bonus aria; see BUILD_VALIDATION.md

  notes: |

    Distinct from TASK-390 (copy module migration â€” done). Distinct from TASK-437 (GridListRow facts).

    Owner asked 2026-07-15 whether 438 included sitewide audit â€” it did not; this task owns that work.



- id: TASK-429

  title: Guided feat steps â€” Layer 2 browse (GuidedLayerNav)
  ...
  developer_test_plan: |
    ...
    DEV-V-013-T012 â€” Archetype + character feat See more ? L2 browse; Back to recommendations.
  ...
  description: |
    ...
    Add Layer 2 to guided archetype feats and character feat steps per REALMS â€”3 / â€”5.6.
  ...
  acceptance_criteria:
    ...
    - Both feat steps show GuidedLayerNav "See moreâ€”" below L1 cards.
  ...
  notes: |
    ...
    Owner ask 2026-07-11 â€” Layer 2 like abilities go-deeper / go-back, not grey-out lock.
...
- id: TASK-428
  ...
  title: Guided archetype feats â€” swap selection like ancestry
  ...
  developer_test_plan: |
    ...
    DEV-V-013-T011 â€” At-cap archetype feat cards stay interactive; pick another swaps (no grey-out).
  ...
  acceptance_criteria:
    ...
    - Character feat step already replaces â€” no regression.

  notes: |

    Owner feedback 2026-07-11 â€” selection grammar unity with ancestry traits.
...
- id: TASK-427
  ...
  title: Add modals â€” browse when selection budget exhausted
  ...
  developer_test_plan: |
    ...
    DEV-V-013-T010 â€” Browse all skills with 0 points: readable rows, selectable + warning, Add blocked until points freed.
  ...
  notes: |
    ...
    Owner feedback 2026-07-11 â€” guided skills add modal; pattern applies to all add modals.
...
- id: TASK-426
  ...
  title: Guided ancestry â€” Skip no flaw as choice card
  ...
  developer_test_plan: |
    ...
    DEV-V-013-T009 â€” Flaw step Skip card matches GuidedChoiceCard grid; select + Next pick advances.
  ...
  description: |
    ...
    Optional flaw step showed Skip as a small secondary Button under the card grid â€” visually
  ...
  notes: |
    ...
    Owner feedback 2026-07-11 â€” screenshot audit `.guided-flaw-audit/`.
...
- id: TASK-425
  ...
  title: SegmentedControl idle segments â€” clearer borders (species size)
  ...
  developer_test_plan: |
    ...
    DEV-V-013-T008 â€” Species overview size SegmentedControl idle borders visible before selection.
  ...
  notes: |
    ...
    Owner feedback 2026-07-11 â€” size buttons unclear until selected; fix universal component.
...
- id: TASK-424
  ...
  developer_test_plan: |
    ...
    DEV-V-013-T004 â€” Berserker quick kits + phased weapon L1 cards.

    DEV-V-013-T006 â€” See more opens Layer 2 modal with TP bar.

    DEV-V-013-T013 â€” Weapon ? armor ? gear phase walk + progress chips.
  ...
  completed_work: |
    ...
    Phase 4â€”6: guided-equipment-l1-phase.tsx (unified weapon/armor/gear L1 GuidedChoiceCard);
  ...
  description: |
    ...
    REALMS â€”5.7 and GUIDED_EQUIPMENT_PHASED_SPEC.md. Layer 1 GuidedChoiceCard per phase; Layer 2
  ...
  notes: |
    ...
    Phases 0â€”1 libs first; UI phases 3â€”7; content TASK-423 owner-gated.
...
- id: TASK-422
  ...
  title: Guided equipment step â€” loadout UX rework (â€”5.7)
  ...
  developer_test_plan: |
    ...
    DEV-V-013-T004 â€” Berserker phased loadout + quick kits.

    DEV-V-013-T006 â€” See more opens Layer 2 modal with TP bar (Confirm applies).

    DEV-V-013-T007 â€” Admin path save rejects loadout exceeding TP budget.

    DEV-V-013-T013 â€” Weapon ? armor ? gear phase walk.

  description: |

    Replace minimal guided loadout cards with REALMS â€”5.7 equipment UX. Superseded UI path
  ...
  completed_work: |
    ...
    Phases 1â€”3 (2026-07-05): item resolution, sections/unarmed, customize + admin TP.

    Superseded by TASK-424 phased L1/L2 (customize panel removed Phase 7).

    2026-07-13 audit: marked done â€” UI AC delivered by TASK-424; seed leftover = TASK-423 only.
  ...
  notes: |
    ...
    Owner review 2026-07-05: TASK-401 shipped minimal cards; product vision in REALMS â€”5.7 not met.

    Live DB: 1/12 paths have loadouts (Berserker only); Monk has unarmed flag but no loadouts.

    2026-07-13: Closed as done â€” do not chase deleted GuidedLoadoutCustomizePanel / section UI.
...
- id: TASK-419
  ...
  title: Guided skills step â€” Layer 1 presentation (â€”5.5)
  ...
  description: |
    ...
    simplified rows (bonus â€”, X remove), path skill chips in PathHelpCard, browse-all link instead of floating Add Skill.
  ...
  developer_test_plan: |
    ...
    DEV-V-013-T014 â€” Guided skills Layer 1 (path chips + budget + browse).
...
- id: TASK-321
  ...
  completed_work: |
    ...
    - Batch 3â€”4 (2026-07-13): cleared all unused-vars (141?0); fixed 4 lint errors (raw color tokens,
...
- id: TASK-346
  ...
  completed_work: |
    ...
    - Batch 1â€”2: footer/roll-button/console purge; status -600?-700; home/item-creator neutrals.

    - Batch 3â€”4: emptied TSX backlog allowlist; semantic tokens across admin/codex/creators/sheet/shared.
...
- id: TASK-376
  ...
  title: Retire DB tooltips â€” full migration to Collin Tippy + tooltip-text.tsx
  ...
  description: |
    ...
    Contextual help uses `InfoTippy` + `public/tooltip-text.tsx` (Floating UI engine â€” see TASK-392).
...
- id: TASK-379
  ...
  build_validation: DEV-V-016-T001â€”T006
  ...
  notes: |
    ...
    2026-07-13: Done â€” LoadFromLibraryModal ? UnifiedSelectionModal (confirmLabel Load, max 1);
...
- id: TASK-380
  ...
  developer_test_plan: |
    ...
    Run DEV-V-018-T001â€”T006 in BUILD_VALIDATION.md (six creators + mobile shell).

  notes: |

    2026-07-14: Done â€” CreatorPageShell on all six standalone creators; CollapsibleSection is the only
    ...
    2026-07-01: Owner â€” Phase 1b prerequisite for standalone guided creators (REALMS â€”5.11).



- id: TASK-431

  title: Creator chrome follow-ups â€” a11y, load-hook parity, empowered copy/errors
  ...
  acceptance_criteria:
    ...
    - Species and/or creature load lists use an extended useLoadModalLibrary (or dedicated shared hook) with SourceFilter parity â€” no bespoke fetch/shape duplication beyond entity-specific columns/handleLoad.
    ...
    - Optional: shell `loading` gate (or documented intentional skip) for species skills/traits and creature critical codex deps â€” align with power/tech/item or document "show UI immediately" in AGENT_GUIDE.
  ...
  notes: |
    ...
    2026-07-14: Done â€” CollapsibleSection a11y (dedicated expand button, h2 titles); useLoadModalLibrary
  ...
  developer_test_plan: |
    ...
    Run DEV-V-018-T001â€”T007 in BUILD_VALIDATION.md (chrome + load-hook/Collapsible a11y).
...
- id: TASK-383
  ...
  title: "UI unification â€” Phase 0a: automated visual + a11y + contrast safety net"
  ...
  completed_work: |
    ...
    - Playwright + `@axe-core/playwright`: `tests/visual/` â€” full-page screenshot baselines (54)
  ...
  developer_test_plan: |
    ...
    Suite DEV-V-011 T001â€”T004 â€” see BUILD_VALIDATION.md. Human steps (CI secrets, Linux baseline
...
- id: TASK-384
  ...
  completed_work: |
    ...
    - `tests/visual/a11y-baseline.json` emptied â€” zero allowed violations.
  ...
  acceptance_criteria:
    ...
    - Fix the near-global `aria-prohibited-attr` (appears on nearly every page â€” likely one shared
...
- id: TASK-385
  ...
  completed_work: |
    ...
    - `scripts/provision-e2e-baseline.js` + `tests/visual/e2e-seed-manifest.json` â€” deterministic user/character/campaign seed.

    - `auth.setup.ts` + `playwright.auth.config.ts` â€” storageState login (login once, reuse session).

    - Visual baselines: my-account, characters, campaigns, character-sheet, campaign-detail â€” light/dark (10 snapshots).
...
- id: TASK-387
  ...
  description: |
    ...
    Scrap and rebuild `home-page.tsx` per REALMS_PRODUCT_OVERVIEW Section 4 â€”
  ...
  remaining_work: |
    ...
    (None â€” licensed character/item art integrated 2026-06-28: Faust hero, Human-Greyscale
...
- id: TASK-389
  ...
  title: "Landing visual assets â€” replace uniqueness placeholder panels"
...
- id: TASK-390
  ...
  description: |
    ...
    â€” one module per page or area for easy editing while viewing a route.
  ...
  developer_test_plan: |
    ...
    Run DEV-V-017-T001â€”T006 in BUILD_VALIDATION.md (About, nav, rules, resources, privacy, terms).

    Optional screenshot audit: `npx playwright test -c playwright.site-copy-audit.config.ts` ? `.site-copy-audit/`.

  notes: |

    2026-07-14: Done â€” About carousel ? structured `ABOUT_CAROUSEL_SLIDES` + `AboutSlideBodyView`;
    ...
    Rules Google Docs iframe may be blank in headless/third-party frames â€” â€”Open in new tabâ€” still works.
...
- id: TASK-393
  ...
  title: Guided Simple Creator â€” docs & product model (REALMS â€”5.0)
...
- id: TASK-394
  ...
  title: Guided Simple Creator â€” Phase 0 entry chooser & routes
...
- id: TASK-395
  ...
  title: Guided Simple Creator â€” Phase 1 shell (rail, preview, footer)
...
- id: TASK-396
  ...
  title: Guided Simple Creator â€” schema fields & seed SQL
...
- id: TASK-397
  ...
  title: Guided Simple Creator â€” Phase 2 Foundation (path + species)
...
- id: TASK-398
  ...
  title: Guided Simple Creator â€” Phase 3 Ancestry micro-flow
...
- id: TASK-399
  ...
  title: Guided Simple Creator â€” Phase 4 Abilities
...
- id: TASK-400
  ...
  title: Guided Simple Creator â€” Phase 4 Your Archetype (skills + feats)
...
- id: TASK-401
  ...
  title: Guided Simple Creator â€” Phase 5 Equipment + Powers/Techniques
...
- id: TASK-402
  ...
  title: Guided Simple Creator â€” Phase 6 Your Hero (reveal + save)
...
- id: TASK-407
  ...
  title: Guided creator â€” skills step full allocation (â€”5.5 Option B)
  ...
  notes: |
    ...
    2026-06-30: Owner chose Option B â€” full allocation per REALMS â€”5.5. Store schema v3 (skillIds ? skills). npm run build pass.
...
- id: TASK-406
  ...
  title: Guided creator â€” Your Hero reveal redesign (â€”5.10)
  ...
  description: |
    ...
    Redesign guided reveal/finalize step to match REALMS â€”5.10: hero reveal moment, full build summary with names and edit jump-backs, identity fields, portrait upload, smart HP/EN allocation, reveal-first layout.
  ...
  notes: |
    ...
    2026-06-30: Owner feedback â€” guided reveal was worst finalize step; redesign in stages.
...
- id: TASK-415
  ...
  acceptance_criteria:
    ...
    - Two chip roles documented and implemented â€” ExpandableChip (interactive) + DescriptorChip (opaque, non-expandable)
  ...
  remaining_work: |
    ...
    None â€” TASK-415 complete. Expandable chips (options, leveled feats, traits with descriptions) correctly omit explicit `kind`.

  notes: |

    Owner feedback 2026-07-02. Phase 2.2 unified token maps; this task completes semantic/UX chip unification.

    Implement in sub-phases Aâ€”E per CHIP_UNIFICATION_PLAN.md (primitives ? merge ? descriptors ? metadata audit ? cleanup).



- id: TASK-416

  title: Feat tag unification â€” taxonomy cleanup + untagged feats
  ...
  acceptance_criteria:
    ...
    - Phase 1â€”2 SQL applied; unique tags materially reduced (349 ? ~277 achieved)
  ...
  completed_work: |
    ...
    Phase 1â€”2 (2026-07-03): SQL functions + live DB apply â€” 277 unique tags.
    ...
    Phase 4 (TASK-418, 2026-07-03): singleton merges â€” 172 unique tags. See `feat-tags-unification-phase4.sql`.

  remaining_work: |

    None â€” feat tag unification complete (phases 1â€”4).

  notes: |

    Owner approved phases 3â€”4 apply 2026-07-03. Codex data workflow: realms-codex-data.mdc.



- id: TASK-418

  title: Feat tag unification â€” Phase 4 singleton merges
  ...
  description: |
    ...
    Merge singleton/low-count tags into canonical families; fix phase 1â€”2 over-drops (Focus, Movement).
...
- id: TASK-420
  ...
  notes: |
    ...
    Follow-up to TASK-378. Complements TASK-379 (pipeline unification) â€” typing first, unification second.
...
- id: TASK-421
  ...
  notes: |
    ...
    2026-07-13: Done â€” `OfficialEnhancedItemPayload` + create/patch inputs in `crafting.ts`; hook uses
...
- id: TASK-474
  ...
  title: AI agent workflow overhaul â€” constitution, ACTIVE_TASKS, CI, Library shell
...
- id: TASK-482
  ...
  notes: |
    ...
    Shipped in audit follow-up pass 2026-07-15. Remaining debt: TASK-476â€”481.
...
- id: TASK-404
  ...
  developer_test_plan: |
    ...
    Suite DEV-V-008 T014 Ã¢â‚¬â€ see BUILD_VALIDATION.md
