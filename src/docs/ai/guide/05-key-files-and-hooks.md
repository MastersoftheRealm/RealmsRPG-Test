...
| **Entity card art (list thumb, choice cards, upload)** | `REALMS_PRODUCT_OVERVIEW.md` §5.0.3 + [`03-entity-card-art.md`](03-entity-card-art.md); `guided-choice-image.ts`, `list-row-image.ts`, `codex-art.ts` |
