...
- **Stable vertical expand (sitewide, TASK-445 / TASK-504):** Click-to-expand controls must keep the opened control on its collapsed vertical row. Horizontal movement is allowed for a clearer reading layout: the expanded chip moves to the group’s left edge and occupies the full width. Every chip from that same row onward reflows below it.
