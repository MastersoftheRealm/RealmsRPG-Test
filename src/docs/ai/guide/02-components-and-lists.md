...
| UnifiedSelectionModal | AddFeat/Skill/SubSkill/LibraryItem, LoadFromLibrary, CraftingItemSelect, AddCreatureFeat, guided L2 (feats/equipment/powers); proficiency pending TASK-567 |
| library-selectable-builders | Add + Load library SelectableItem shaping (shared pipeline) |
| useModalListState | Rare non-USM list shells only (AddProficiency until TASK-567; AdminSpecies trait picker) |
