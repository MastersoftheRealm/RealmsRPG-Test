...
| Creator skill-save rows (Guided + Advanced) | `lib/creator/build-creator-skills.ts` (`buildCreatorSkillSaveRows` — preserves proficient skill_val 0 before `cleanForSave`); Guided wrapper `lib/guided-creator/build-skills.ts` |
