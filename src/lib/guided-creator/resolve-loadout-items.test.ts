...
describe('resolve-loadout-items', () => {
  const lookup = buildEquipmentLookup(
    [
      {
        id: '486b9ac9-16e3-49f8-80de-6d4c9ebbf3bc',
        docId: '486b9ac9-16e3-49f8-80de-6d4c9ebbf3bc',
        name: 'Greatsword',
        type: 'weapon',
        properties: [],
  ...
  const loadout: PathLoadout = {
    id: 'test-kit',
    title: 'Test kit',
    armaments: [{ id: '486b9ac9-16e3-49f8-80de-6d4c9ebbf3bc', quantity: 1 }],
    armor: [{ id: '8ca40c97-851c-4381-a6dd-e0724a6927cf', quantity: 1 }],
  ...
  it('marks missing refs as unresolved', () => {
    ...
    const armor = items.find((i) => i.id === '8ca40c97-851c-4381-a6dd-e0724a6927cf');
  ...
  it('groups resolved items by category for section display', () => {
    const lookupWithArmor = buildEquipmentLookup(
      [
        ...
        {
          id: '8ca40c97-851c-4381-a6dd-e0724a6927cf',
          docId: '8ca40c97-851c-4381-a6dd-e0724a6927cf',
          name: 'Scalemail',
          type: 'armor',
          properties: [],
          damageReduction: 14,
