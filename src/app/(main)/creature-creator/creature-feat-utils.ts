...
import { formatFeatName, getFeatFamilyId, getFeatLevel } from '@/lib/leveled-feats';
...
export function creatureToFeatRequirementCharacter(
...
export function mergeCreatureFeatsOnAdd(
  ...
  return added.reduce<CreatureFeat[]>(
    (acc, nextFeat) => {
