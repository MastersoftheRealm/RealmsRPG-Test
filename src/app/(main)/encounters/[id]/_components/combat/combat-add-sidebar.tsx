...
export interface CombatAddSidebarProps {
  ...
  availableCampaignCharacterCount: number;
...
export function CombatAddSidebar({
  ...
  campaignsFull,
  linkedCampaign,
  availableCampaignCharacterCount,
  addingAllChars,
  newCombatant,
  setNewCombatant,
  onOpenAddModal,
        ...
        <div className="mb-4 space-y-2">
          ...
          {linkedCampaign && (linkedCampaign.characters?.length ?? 0) > 0 && (
            <Button
              ...
              disabled={
                addingAllChars || encounter.isActive || availableCampaignCharacterCount === 0
              }
            >
              {addingAllChars
                ? 'Adding…'
                : availableCampaignCharacterCount === 0
                  ? 'All Characters Added'
                  : `Add all Characters (${availableCampaignCharacterCount})`}
            </Button>
          )}
        </div>
