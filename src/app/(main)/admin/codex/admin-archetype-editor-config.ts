...
export const selectionFieldConfig: Array<{
  key: PathSelectionKey;
  label: string;
  placeholder: string;
}> = [
...
export const removeFieldConfig: Array<{
  key: PathSelectionKey;
  label: string;
  placeholder: string;
}> = [
  {
    key: 'removeFeats',
    label: 'Remove Feats',
    placeholder: 'Select feats to remove at this level',
  },
  {
    key: 'removePowers',
    label: 'Remove Powers',
    placeholder: 'Select powers to remove at this level',
  },
  {
    key: 'removeTechniques',
    label: 'Remove Techniques',
    placeholder: 'Select techniques to remove at this level',
  },
  {
    key: 'removeArmaments',
    label: 'Remove Armaments',
    placeholder: 'Select armaments to remove at this level',
  },
];
