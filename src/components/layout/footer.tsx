...
const footerLinkClass =
  'font-semibold text-sm sm:text-base text-text-primary hover:text-primary-700 dark:hover:text-primary-300 transition-colors whitespace-nowrap min-h-[44px] flex items-center justify-center';
