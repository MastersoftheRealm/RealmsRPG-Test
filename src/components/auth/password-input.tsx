      ...
      <div className="space-y-1.5">
        ...
        <div className="relative">
          <input
            ...
            className={cn(
              'w-full rounded-lg border bg-surface px-4 py-3 pr-12 text-text-primary',
          ...
          <button
            ...
            className="absolute top-1/2 right-3 flex min-h-[44px] min-w-[44px] -translate-y-1/2 items-center justify-center text-text-muted transition-colors hover:text-text-primary dark:hover:text-text-on-dark"
            tabIndex={-1}
