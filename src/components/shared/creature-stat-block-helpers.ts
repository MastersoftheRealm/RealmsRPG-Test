...
export const REALMS_ABILITY_ORDER = ['strength', 'vitality', 'agility', 'acuity', 'intelligence', 'charisma'] as const;
...
export function getAbilityValue(abilities: CreatureAbilities, key: (typeof REALMS_ABILITY_ORDER)[number]): number {
...
export function partsToChips(parts: Array<string | { id?: string | number; name?: string; op_1_lvl?: number; op_2_lvl?: number; op_3_lvl?: number }> | undefined, codexParts: CodexPart[]): ChipData[] {
...
export function resolveArmamentProperties(
