...
const CORE_RULES = {
  ...
  CONDITIONS: {
    blinded: {
      name: 'Blinded',
      description: 'Cannot see; auto-fail sight-based; attacks have disadvantage.',
    },
    charmed: {
      name: 'Charmed',
    ...
    frightened: {
      name: 'Frightened',
      description: 'Disadvantage while source of fear in line of sight.',
    },
    grappled: {
      name: 'Grappled',
      description: 'Speed 0; ends if grappler incapacitated or moved.',
    },
    incapacitated: { name: 'Incapacitated', description: 'Cannot take actions or reactions.' },
    invisible: {
      name: 'Invisible',
      description: 'Cannot be seen without aid; attacks have advantage.',
    },
    paralyzed: {
      name: 'Paralyzed',
      description: 'Incapacitated; auto-fail STR/DEX; attacks from 5 ft have advantage and crit.',
    },
    petrified: {
      name: 'Petrified',
      description: 'Turned to stone; incapacitated; weight and age suspended.',
    },
    poisoned: { name: 'Poisoned', description: 'Disadvantage on attacks and ability checks.' },
    prone: {
      name: 'Prone',
      description: 'Only crawl or stand; melee advantage / ranged disadvantage.',
    },
    restrained: {
      name: 'Restrained',
      description: 'Speed 0; disadvantage on attacks and DEX saves; attacks have advantage.',
    },
    stunned: {
      name: 'Stunned',
      description: 'Incapacitated; auto-fail STR/DEX; cannot move; attacks have advantage.',
    },
    unconscious: {
      name: 'Unconscious',
      description: 'Incapacitated; prone; drop held; auto-fail STR/DEX; attacks from 5 ft crit.',
    },
  },
  ...
  SIZES: {
    ...
    spaceAndShape:
      'Creatures are classified into size categories based on their height and, in some cases, width. Generally, larger creatures take up more space on a battle map. For instance, a Huge creature occupies 4 spaces. When a creature occupies multiple spaces, those spaces are typically adjacent to one another; some creatures may have unique shapes. A creature whose width matches a larger category’s typical height uses the larger size (for example, a horse about 150 cm tall and 250 cm long is Large).',
    carryingNotes:
      'Carrying capacity is determined by size. If you carry more than half your maximum capacity, your movement speed is halved. Regardless of Strength, you can carry at least the size’s minimum (the kilogram bonus you would multiply by Strength) even if Strength is negative — for example, Tiny at Strength −2 still carries 10 kg.',
    ...
    successesTable: [
      {
        delta: 0,
        failureEffect: '—',
        successEffect: 'Create fully functional item worth market price with no complications.',
      ...
      {
        delta: 1,
        failureEffect: 'The item is worth 75% of the market price.',
        successEffect: 'The item is worth 125% of the market price.',
      ...
      {
        delta: 2,
        failureEffect: 'The item is worth 50% of the market price.',
        successEffect:
          'You retain 25% of the crafting materials and the item is worth 125% of the market price.',
        failureItemWorthPercent: 50,
        successItemWorthPercent: 125,
        materialsRetainedPercent: 25,
        choiceExtraItemOrEnhance: false,
      },
      {
        delta: 3,
        failureEffect: 'The item is worth 25% of the market price.',
        successEffect:
          'You retain 50% of the crafting materials and the item is worth 125% of the market price.',
        failureItemWorthPercent: 25,
        successItemWorthPercent: 125,
        materialsRetainedPercent: 50,
        choiceExtraItemOrEnhance: false,
      },
      {
        delta: 4,
        failureEffect: "The item is worthless and doesn't function as intended.",
        successEffect:
          'You retain 50% of the crafting materials and the item is worth 150% of the market price.',
        failureItemWorthPercent: 0,
        successItemWorthPercent: 150,
        materialsRetainedPercent: 50,
        choiceExtraItemOrEnhance: false,
      },
      {
        ...
        failureEffect: '—',
        successEffect:
          'You retain 75% of the crafting materials and the item is worth 150% of the market price.',
        successItemWorthPercent: 150,
        materialsRetainedPercent: 75,
        choiceExtraItemOrEnhance: false,
      },
      {
        delta: 6,
        failureEffect: '—',
        successEffect:
          'You retain 75% of the crafting materials and the item is worth 175% of the market price.',
        successItemWorthPercent: 175,
        materialsRetainedPercent: 75,
        choiceExtraItemOrEnhance: false,
      },
      {
        ...
        failureEffect: '—',
        successEffect:
          'You retain 75% of the materials and can choose: craft an additional identical item (both at 100%) or enhance the original to 200% value.',
        successItemWorthPercent: 200,
        materialsRetainedPercent: 75,
        choiceExtraItemOrEnhance: true,
      },
      {
        delta: 8,
        failureEffect: '—',
        successEffect: 'As delta 7, plus one additional item at 100% per success above 7.',
        successItemWorthPercent: 200,
        materialsRetainedPercent: 75,
        extraItemCount: 1,
        choiceExtraItemOrEnhance: true,
